...
$sql = "SELECT corsi_online.*, categorie_corsi_online.categoria AS categoria_nome
        FROM corsi_online
        INNER JOIN categorie_corsi_online ON corsi_online.categoria = categorie_corsi_online.id WHERE LOWER(SUBSTRING_INDEX(corsi_online.file_video, '.', -1)) = 'mp3'";
...
<body>
    ...
    <div class="action-menu">
        <h1 class="h1-gestionale">Gestione Audio</h1>
        ...
        <div class="menu-action-categories">
            ...
            <div class="info-icon"><a href="/area-corsi-online/php/gestionale/inserimento_audio.php" style="color:white;text-decoration:none;"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><style>svg{fill:#ffffff}</style><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/></svg> Aggiungi audio</a></div>
