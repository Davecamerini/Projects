...
// Controlla se è stato fornito l'ID del fornitore da eliminare
if (isset($_GET['id'])) {
    $fornitore_id = intval($_GET['id']);

    // Query per eliminare il fornitore
    $delete_query = "DELETE FROM fornitori_scheda WHERE id=$fornitore_id";
    ...
    if ($conn->query($delete_query)) {
        ...
        $success = false;
        $message = "Errore durante l'eliminazione del fornitore: " . $conn->error;
    }
}
$conn->close();
?>
...
<div class="content-card">
    <h1>Eliminazione Fornitore</h1>
    <p>Operazione di eliminazione fornitore in corso...</p>
</div>
...
$(document).ready(function() {
    ...
    setTimeout(function() {
        window.location.href = 'dashboard.php?page=fornitori';
    }, 3000);
});
</script>
