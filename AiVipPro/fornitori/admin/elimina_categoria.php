...
$subcategories_query = "SELECT id FROM fornitori_categorie WHERE genitore = $id";
...
if ($subcategories->num_rows > 0) {
    ...
    $delete_query = "DELETE FROM fornitori_categorie WHERE id = $id";
...
$(document).ready(function() {
    ...
    setTimeout(function() {
        window.location.href = 'dashboard.php?page=categorie';
    }, 3000);
});
</script>
