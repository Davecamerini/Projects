...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $insert_query = "INSERT INTO borghi_categorie (titolo, slug, descrizione, genitore, data_inserimento, immagine)
...
$categories = $conn->query("SELECT id, titolo FROM borghi_categorie WHERE genitore = 0");
