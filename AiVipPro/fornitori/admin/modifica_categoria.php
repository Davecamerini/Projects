...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_query = "UPDATE fornitori_categorie
...
$categoria_query = "SELECT * FROM fornitori_categorie WHERE id = $id";
...
$categories = $conn->query("SELECT id, titolo FROM fornitori_categorie WHERE genitore = 0 AND id != $id");
