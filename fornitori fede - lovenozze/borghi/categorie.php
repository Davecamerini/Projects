...
// Query per ottenere le categorie dalla tabella borghi_categorie
$sql = "SELECT id, titolo, descrizione, immagine, slug FROM borghi_categorie";
...
<head>
    ...
    <title>Categorie di borghi - Lovenozze</title>
...
<div class="content-page-borghi">
    <h1 class="text-center mb-3">Un Viaggio tra Arte, Storia e Natura</h1>
    <p style="max-width:850px; margin:auto;" class="text-center mb-5">Dai borghi arroccati sulle Dolomiti, come Castelrotto e Vipiteno, a quelli che si affacciano sulle acque cristalline della Liguria, come Vernazza e Portovenere, ogni angolo di questi luoghi trasmette emozioni uniche.</p>
