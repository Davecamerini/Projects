...
$category_query = "SELECT id, titolo FROM fornitori_categorie";
      ...
      <?php include "partial/sidebar.php"; ?>
        ...
        <div class="main-content">
            <div class="content-card">
                ...
                <form action="process/inserisci_fornitore.php" method="POST" enctype="multipart/form-data">
                  <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="descrizione_due" name="descrizione_due" class="form-control" required></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="video_files">Carica Video</label>
